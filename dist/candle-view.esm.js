...
var useCandleHook = function useCandleHook(args, xAxis, yAxis, baseConfig) {
  ...
  var _useState = useState(merge(DEFAULTDATAVALUES, args)),
      initArgs = _useState[0],
      _setinitArgs = _useState[1];
  ...
  var initDynamicData = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      ...
      var endTime, preTime, _timeInteger, startTime, result, heightPixVolumArea;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              startTime = xAxis.data.currentTimeType.backwardTimeUnit(_timeInteger, preTime, baseConfig.timeZone.displayTimeZone);
              _context.next = 30;
  ...
  return {
    ...
    funcs: {
      ...
      setinitArgs: function setinitArgs(arg) {
        _setinitArgs(merge(initArgs, arg));
      }
    },
    initArgs: initArgs
  };
...
var useCandleView = function useCandleView(args) {
   ...
   *默认参数状态
   */
  var _useState = useState(merge(DEFAULTVALUES, args)),
      initArgs = _useState[0],
