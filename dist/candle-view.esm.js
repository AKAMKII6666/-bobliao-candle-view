import React, { useState, useRef, useEffect, createContext, useContext, memo, useMemo } from 'react';
import _bigNumber from 'bignumber.js';
import lodash from 'lodash-es';
import { PixiComponent, Container, Text, Stage } from '@pixi/react';
import useJquery from '@bobliao/use-jquery-hook';
import ResizeObserver from 'resize-observer-polyfill';
import { Graphics, utils, TextStyle } from 'pixi.js';
...
var useThrottle = function useThrottle() {
  ...
  var ThrottleFunction = useRef(null);
...
var usexAxis = function usexAxis(args, igorn, config) {
  ...
  var _useState = useState(Object.assign(true, DEFAULTAXISVALUES, args)),
  ...
  }, [currentTimeType, currentTimeScope]); //初始化状态以后初始化数轴
...
var useCandleHook = function useCandleHook(args, xAxis, yAxis, baseConfig) {
  ...
  var _useState = useState(lodash.merge(DEFAULTDATAVALUES, args)),
      initArgs = _useState[0],
      _setinitArgs = _useState[1];
  ...
  var _useState14 = useState(0),
      setcleanY = _useState14[1]; //全量更新的时候才会更新这个guid,这个guid是用来判断每个candle是否需要进行重新计算的标志
  //每次全量更新会更新一次，每次都不太一样。
  ...
  var allComputedCandleData = useRef({});
  var isUpdateing = useRef(false);
  var isQuickUpdateing = useRef(false);
  var mWorker = useRef();
  /**
   * ==========================静态常量==============================
   */
...
var useCandleView = function useCandleView(args) {
   ...
   *默认参数状态
   */
  var _useState = useState(lodash.merge(DEFAULTVALUES, args)),
      initArgs = _useState[0],
...
var useDebounce = function useDebounce() {
  ...
  var debounceFunction = useRef(null);
...
var Rectangle = /*#__PURE__*/PixiComponent('Rectangle', {
...
var KlineBatching = /*#__PURE__*/PixiComponent('KlineBatching', {
  create: function create() {
    return new Graphics();
  },
  applyProps: function applyProps(instance, oldProps, props) {
...
var VolumeBatching = /*#__PURE__*/PixiComponent('VolumeBatching', {
  create: function create() {
    return new Graphics();
  },
  applyProps: function applyProps(instance, oldProps, props) {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose(new_props.data), _step3; !(_step3 = _iterator3()).done;) {
      ...
      var volumeProps = {
         ...
         * 颜色
         */
        color: utils.string2hex(function () {
...
var DEFAULTRECTANGLE = {
  color: /*#__PURE__*/utils.string2hex('#000000'),
  size: {
    width: 100,
    height: 100
  },
...
var DashedLine = /*#__PURE__*/PixiComponent('DashedLine', {
  create: function create() {
    return new Graphics();
  },
...
var XAxis = function XAxis(_ref2, _ref) {
  ...
  var tooltipTextRef = useRef(null); //===============function=================
  ...
  var makeTicks = function makeTicks() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(CVData.hookObjs.xAxisObj.data.displayTickArr), _step; !(_step = _iterator()).done;) {
      var item = _step.value;
      result.push(React.createElement(React.Fragment, {
        key: index + "_d"
      }, React.createElement(Rectangle, {
        color: utils.string2hex(item.color),
        size: {
          width: item.size,
          height: item.length
        },
    ...
    for (var _iterator2 = _createForOfIteratorHelperLoose(CVData.hookObjs.xAxisObj.data.displayTickArr), _step2; !(_step2 = _iterator2()).done;) {
      ...
      result.push(React.createElement(React.Fragment, {
        ...
        style: new TextStyle({
          ...
          fill: utils.string2hex(CVData.hookObjs.xAxisObj.initArgs.tickColor)
        })
      })));
      index++;
    }
  ...
  var makeTooltip = function makeTooltip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(DashedLine, {
      color: utils.string2hex(CVData.hookObjs.xAxisObj.initArgs.tooltip.color),
      ...
      color: utils.string2hex((_CVData$hookObjs$xAxi = CVData.hookObjs.xAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$xAxi2 = _CVData$hookObjs$xAxi.label) == null ? void 0 : _CVData$hookObjs$xAxi2.backGroundColor),
      size: {
      ...
      color: utils.string2hex((_CVData$hookObjs$xAxi3 = CVData.hookObjs.xAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$xAxi4 = _CVData$hookObjs$xAxi3.label) == null ? void 0 : _CVData$hookObjs$xAxi4.color),
      size: {
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$xAxi9 = CVData.hookObjs.xAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$xAxi10 = _CVData$hookObjs$xAxi9.label) == null ? void 0 : _CVData$hookObjs$xAxi10.color)
      })
    }));
  }; //===============effects==================
  ...
  var xBackground = useMemo(function () {
    return React.createElement(React.Fragment, null, React.createElement(Rectangle, {
      color: utils.string2hex(CVData.hookObjs.xAxisObj.initArgs.backgroundColor),
      size: {
  ...
  var xAsixElem = useMemo(function () {
    return React.createElement(React.Fragment, null, React.createElement(Rectangle, {
      color: utils.string2hex(CVData.hookObjs.xAxisObj.initArgs.lineColor),
      size: {
  ...
  return React.createElement(React.Fragment, null, xBackground, xAsixElem, React.createElement(Container, {
...
var DataTooltop = function DataTooltop(_ref2, _ref) {
  ...
  var lastDataTooltipTextRef = useRef(null);
  var lastDataTooltipTextRef2 = useRef(null);
  var lastDataTooltipTextRef3 = useRef(null);
  var lastDataTooltipTextRef4 = useRef(null); //===============function=================
  ...
  var makeLastCandleTooltip = function makeLastCandleTooltip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(DashedLine, {
      color: utils.string2hex(CVData.hookObjs.candleObj.data.latestCandleItem.candleColor),
      ...
      color: utils.string2hex((_CVData$hookObjs$cand4 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand5 = _CVData$hookObjs$cand4.currentPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand6 = _CVData$hookObjs$cand5.label) == null ? void 0 : _CVData$hookObjs$cand6.color),
      size: {
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$cand13 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand14 = _CVData$hookObjs$cand13.currentPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand15 = _CVData$hookObjs$cand14.label) == null ? void 0 : _CVData$hookObjs$cand15.color)
      })
    }));
  };
  /* 视图范围内最末尾的candle */
  ...
  var makeLatestCandleToolTip = function makeLatestCandleToolTip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(Rectangle, {
      color: utils.string2hex((_CVData$hookObjs$cand17 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand18 = _CVData$hookObjs$cand17.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand19 = _CVData$hookObjs$cand18.label) == null ? void 0 : _CVData$hookObjs$cand19.backGroundColor),
      size: {
        width: CVData.hookObjs.yAxisObj.data.labelSpace,
      ...
      color: utils.string2hex((_CVData$hookObjs$cand23 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand24 = _CVData$hookObjs$cand23.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand25 = _CVData$hookObjs$cand24.label) == null ? void 0 : _CVData$hookObjs$cand25.color),
      size: {
        width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$cand32 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand33 = _CVData$hookObjs$cand32.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand34 = _CVData$hookObjs$cand33.label) == null ? void 0 : _CVData$hookObjs$cand34.color)
      })
    }));
  };
  /* 创建最后一个candle的tooltip */
  ...
  var makeLastVolumeTooltip = function makeLastVolumeTooltip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(DashedLine, {
      color: utils.string2hex((_CVData$hookObjs$cand36 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : _CVData$hookObjs$cand36.volumChart.currentPriceTooltip.color),
      ...
      color: utils.string2hex((_CVData$hookObjs$cand39 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand40 = _CVData$hookObjs$cand39.volumChart.currentPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand41 = _CVData$hookObjs$cand40.label) == null ? void 0 : _CVData$hookObjs$cand41.backGroundColor),
      size: {
        width: CVData.hookObjs.yAxisObj.data.labelSpace,
      ...
      color: utils.string2hex((_CVData$hookObjs$cand42 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand43 = _CVData$hookObjs$cand42.volumChart.currentPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand44 = _CVData$hookObjs$cand43.label) == null ? void 0 : _CVData$hookObjs$cand44.color),
      size: {
        width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$cand51 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand52 = _CVData$hookObjs$cand51.volumChart.currentPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand53 = _CVData$hookObjs$cand52.label) == null ? void 0 : _CVData$hookObjs$cand53.color)
      })
    }));
  };
  /* 视图范围内最末尾的candle */
  ...
  var makeLatestVolumeToolTip = function makeLatestVolumeToolTip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(Rectangle, {
      color: utils.string2hex((_CVData$hookObjs$cand55 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand56 = _CVData$hookObjs$cand55.volumChart.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand57 = _CVData$hookObjs$cand56.label) == null ? void 0 : _CVData$hookObjs$cand57.backGroundColor),
      size: {
        width: CVData.hookObjs.yAxisObj.data.labelSpace,
      ...
      color: utils.string2hex((_CVData$hookObjs$cand61 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand62 = _CVData$hookObjs$cand61.volumChart.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand63 = _CVData$hookObjs$cand62.label) == null ? void 0 : _CVData$hookObjs$cand63.color),
      size: {
        width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$cand70 = CVData.hookObjs.candleObj.initArgs.candleStyles) == null ? void 0 : (_CVData$hookObjs$cand71 = _CVData$hookObjs$cand70.volumChart.viewLastPriceTooltip) == null ? void 0 : (_CVData$hookObjs$cand72 = _CVData$hookObjs$cand71.label) == null ? void 0 : _CVData$hookObjs$cand72.color)
      })
    }));
  }; //===============effects==================
  ...
  var latestCandleToolTip = useMemo(function () {
  ...
  var lastCandleTooltip = useMemo(function () {
  ...
  var LastVolumeTooltip = useMemo(function () {
  ...
  var LatestVolumeToolTip = useMemo(function () {
  ...
  return React.createElement(React.Fragment, null, LatestVolumeToolTip, LastVolumeTooltip, latestCandleToolTip, lastCandleTooltip);
}; //使用memo不让其因为上级节点的更新而频繁更新


var DataToolTip = /*#__PURE__*/memo(DataTooltop);
...
var YAxis = function YAxis(_ref2, _ref) {
  ...
  var makeTicks = function makeTicks() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(CVData.hookObjs.yAxisObj.data.displayTickArr), _step; !(_step = _iterator()).done;) {
      var item = _step.value;
      result.push(React.createElement(Rectangle, {
        key: index + "_a",
        color: utils.string2hex(item.color),
        size: {
          width: item.length,
    ...
    for (var _iterator2 = _createForOfIteratorHelperLoose(CVData.hookObjs.yAxisObj.data.displayTickArr), _step2; !(_step2 = _iterator2()).done;) {
      ...
      result.push(React.createElement(Text, {
        ...
        style: new TextStyle({
          ...
          fill: utils.string2hex(CVData.hookObjs.yAxisObj.initArgs.tickColor)
        })
      }));
      index++;
    }
  ...
  var makeTooltip = function makeTooltip() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(DashedLine, {
      color: utils.string2hex(CVData.hookObjs.yAxisObj.initArgs.tooltip.color),
      ...
      color: utils.string2hex((_CVData$hookObjs$yAxi = CVData.hookObjs.yAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$yAxi2 = _CVData$hookObjs$yAxi.label) == null ? void 0 : _CVData$hookObjs$yAxi2.backGroundColor),
      size: {
        width: CVData.hookObjs.yAxisObj.data.labelSpace,
      ...
      color: utils.string2hex((_CVData$hookObjs$yAxi3 = CVData.hookObjs.yAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$yAxi4 = _CVData$hookObjs$yAxi3.label) == null ? void 0 : _CVData$hookObjs$yAxi4.color),
      size: {
        width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      style: new TextStyle({
        ...
        fill: utils.string2hex((_CVData$hookObjs$yAxi9 = CVData.hookObjs.yAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$yAxi10 = _CVData$hookObjs$yAxi9.label) == null ? void 0 : _CVData$hookObjs$yAxi10.color)
      })
    }));
  }; //===============effects==================
  ...
  var yBackground = useMemo(function () {
    return React.createElement(React.Fragment, null, React.createElement(Rectangle, {
      color: utils.string2hex(CVData.hookObjs.yAxisObj.initArgs.backgroundColor),
      size: {
        width: CVData.hookObjs.yAxisObj.data.labelSpace,
  ...
  return React.createElement(React.Fragment, null, yBackground, yAxis, yTicks, yLabels, React.createElement(DataToolTip, null), tooltip);
}; //使用memo不让其因为上级节点的更新而频繁更新
...
var Data = function Data(_ref2, _ref) {
  ...
  var makeBatchKline = function makeBatchKline() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(KlineBatching, Object.assign({}, {
  ...
  var batchKLine = React.createElement(React.Fragment, null);

  if (CVData.hookObjs.xAxisObj.data.tickArr.length > 120) {
    batchKLine = useMemo(function () {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Container, {
    ...
    if (CVData.hookObjs.xAxisObj.data.tickArr.length > 120) {
      ...
      return React.createElement(React.Fragment, null, wc.wick, wc.candle);
    }
  }()));
}; //使用memo不让其因为上级节点的更新而频繁更新
  ...
  var makeNetLinesx = function makeNetLinesx() {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(CVData.hookObjs.xAxisObj.data.netLineArr), _step; !(_step = _iterator()).done;) {
      ...
      result.push(React.createElement(React.Fragment, {
        ...
        color: utils.string2hex(CVData.hookObjs.xAxisObj.initArgs.netLineColor),
        size: {
          width: item.size,
          height: item.length
        },
  ...
  var makeNetLinesy = function makeNetLinesy() {
    ...
    for (var _iterator2 = _createForOfIteratorHelperLoose(CVData.hookObjs.yAxisObj.data.netLineArr), _step2; !(_step2 = _iterator2()).done;) {
      ...
      result.push(React.createElement(React.Fragment, {
        ...
        color: utils.string2hex(CVData.hookObjs.yAxisObj.initArgs.netLineColor),
        size: {
          width: item.length,
          height: item.size
        },
...
var VolumChat = function VolumChat(_ref2, _ref) {
  ...
  var makeChatBatching = function makeChatBatching() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(VolumeBatching, Object.assign({}, {
  ...
  var scale = //用允许的最大高度 / 当前图像里的最大高度 = 需要缩放的值
  CVData.hookObjs.candleObj.data.volumChartPixHeight / (CVData.hookObjs.candleObj.data.volumChartPixHeight * (Number(CVData.hookObjs.candleObj.data.volumChartViewMax) / staticMax)); //y轴位置也要减去刚刚计算的缩放
...
var VolumChart = /*#__PURE__*/memo(VolumChat);
...
var Info = function Info(_ref2, _ref) {
  ...
  var makeInfo = function makeInfo() {
    ...
    if (CVData.hookObjs.xAxisObj.data.tooltipState !== null && CVData.hookObjs.xAxisObj.data.tooltipIsShow && typeof CVData.hookObjs.candleObj.data.cursorCandleItem !== 'undefined' && CVData.hookObjs.candleObj.data.cursorCandleItem !== null) {
      ...
      return React.createElement(React.Fragment, null, React.createElement("div", {
        ...
        className: 'timetype'
      }, React.createElement("label", null, LANGUAGES[CVData.initArgs.language].timeFormat[(_CVData$hookObjs$xAxi = CVData.hookObjs.xAxisObj.data.currentTimeType) == null ? void 0 : _CVData$hookObjs$xAxi.lang])), React.createElement("div", null, React.createElement("span", null, "Date:"), React.createElement("label", null, (_CVData$hookObjs$xAxi2 = CVData.hookObjs.xAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$xAxi3 = _CVData$hookObjs$xAxi2.label) == null ? void 0 : _CVData$hookObjs$xAxi3.formatter(_tooltipState.relatedTickItem)), React.createElement("label", null, "GMT +", (_CVData$initArgs$time = CVData.initArgs.timeZone) == null ? void 0 : _CVData$initArgs$time.displayTimeZone)), React.createElement("div", null, React.createElement("span", null, "Open:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(item.open).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Close:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(item.close).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "High:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(item.high).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Low:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(item.low).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Volume:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(item.volume).toFixed(3)))))));
      ...
      return React.createElement(React.Fragment, null, React.createElement("div", {
        ...
        className: 'timetype'
      }, React.createElement("label", null, LANGUAGES[CVData.initArgs.language].timeFormat[(_CVData$hookObjs$xAxi4 = CVData.hookObjs.xAxisObj.data.currentTimeType) == null ? void 0 : _CVData$hookObjs$xAxi4.lang])), React.createElement("div", null, React.createElement("span", null, "Date:"), React.createElement("label", null, (_CVData$hookObjs$xAxi5 = CVData.hookObjs.xAxisObj.initArgs.tooltip) == null ? void 0 : (_CVData$hookObjs$xAxi6 = _CVData$hookObjs$xAxi5.label) == null ? void 0 : _CVData$hookObjs$xAxi6.formatter({
        value: currentItem.time
      })), React.createElement("label", null, "GMT +", (_CVData$initArgs$time2 = CVData.initArgs.timeZone) == null ? void 0 : _CVData$initArgs$time2.displayTimeZone)), React.createElement("div", null, React.createElement("span", null, "Open:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(currentItem.open).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Current:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(currentItem.close).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "High:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(currentItem.high).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Low:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(currentItem.low).toFixed(3))))), React.createElement("div", null, React.createElement("span", null, "Volume:"), React.createElement("label", null, thousandsSplit(Number(new _bigNumber(currentItem.volume).toFixed(3)))))));
    }
  ...
  var infoLayer = useMemo(function () {
    return makeInfo();
...
var CandleView = /*#__PURE__*/memo(function (_ref2, _ref) {
  ...
  var canvasConatiner = useRef(null);
  var resizeObserverRef = useRef(null); //===============function=================
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    color: "white"
  }), React.createElement(Info, null), React.createElement(Stage, {
    options: {
      backgroundAlpha: 0,
  ...
  }, React.createElement(candleViewPixiContext.Provider, {
    value: CVData
...
export { CandleView, candleViewContext, useCandleView, useCandleViewContext };
