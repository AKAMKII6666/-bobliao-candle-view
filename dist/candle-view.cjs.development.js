...
var anyTimeToGMT0000ToTarget = function anyTimeToGMT0000ToTarget(
  time,
  currentTimeZone,
  targetTimeZone
) {
...
var getRangePosition = function getRangePosition(value, range, pixWidth) { //
...
var findIntersection = function findIntersection(tickArr, scope) {
  ...
  if (tickArr.length < 300) {
    for (
      var _iterator = _createForOfIteratorHelperLoose(tickArr), _step;
      ...
      if (
        Number(item.value) >= scope.start &&
        Number(item.value) <= scope.end
      ) {
        result.push(item);
      }
    }
...
var shiftNumber = function shiftNumber(_number, _shiftLength) {
  return new _bigNumber(_number)
    .times(new _bigNumber(10).exponentiatedBy(_shiftLength))
    .toString();
};
/**
 * 将数组快速转换为hash表
...
var roundToNearestTenBigNumber = function roundToNearestTenBigNumber(
  num,
  intGetPar
) {
  // 创建BigNumber实例
...
function binarySearchByKeyStrictlyEqual(inputArr, target, targetType, key) {
  ...
  if (
    targetType === 'forEnd' &&
    target === getItem(inputArr, inputArr.length - 1)
  ) {
    return inputArr.length - 1;
  }
...
var findIntersectionByKey = function findIntersectionByKey(
  inputArr,
  scope,
  key
) {
...
var translateNumberT = function translateNumberT(_num, _fix) {
  ...
  if (nIARR.length >= 11) {
    var _num10 = new _bigNumber(_num)
  ...
  if (nIARR.length >= 10) {
    var _num11 = new _bigNumber(_num)
  ...
  if (nIARR.length >= 7) {
    var _num12 = new _bigNumber(_num)
      .dividedBy(new _bigNumber(10).exponentiatedBy(6).toFixed())
      .toFixed(_fix, 1);
  ...
  if (nIARR.length >= 4) {
    var _num13 = new _bigNumber(_num)
...
var DEFAULTDATAVALUES = {
  ...
  dynamicData: {
    ...
    dataFetchCallback: /*#__PURE__*/ (function() {
      var _dataFetchCallback = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee(time, start, end) {
...
var findRoundTimeCountFromArray = function findRoundTimeCountFromArray(
  array,
  timeShift,
  currentType,
  key
  ...
  var findRoundTimeCount = function findRoundTimeCount(timeType) {
    ...
    var latestEqualIndex = binarySearchByKeyStrictlyEqual(
      array,
      round,
      'forEnd',
      key
    ...
    var nextRound = timeType.backwardSingleUnit(
      getItemTime(array, latestEqualIndex),
      getTimeShift()
    ); //找到下一个这个时间类型的整数点

    var nextEqualIndex = binarySearchByKeyStrictlyEqual(
      array.slice(0, latestEqualIndex),
      nextRound,
      'forEnd',
      key
    );
  ...
  for (var timeTypeItem in _timeTypeMap) {
    if (
      ...
      result.push(
        _extends({}, findRoundTimeCount(item), {
          type: item,
        })
      );
    }
...
var usexAxis = function usexAxis(args, igorn, config) {
  ...
  var initAxisSates = function initAxisSates(
    timeType,
    viewWidth,
    viewHeight,
    yAxisLabelSpace
  ...
  var timeSpeculation_backrward = function timeSpeculation_backrward(
    timeInteger,
    initTimeScopeStart
  ) {
  ...
  var timeSpeculation_forward = function timeSpeculation_forward(
    timeInteger,
    initTimeScopeEnd
  ) {
    var currentTime = timeInteger;
  ...
  var updateTicks = function updateTicks(
    targetTickArr,
    timeScope,
    isComputCommonProp,
    _moveAmount,
    ...
    if (moveDir === 'add' || moveDir === 'all') {
      var forwardArr = timeSpeculation_forward(
        targetTickArr[targetTickArr.length - 1].value,
        timeScope.end
      );

      if (forwardArr.length > 1) {
        var arr = createTickers(
          forwardArr,
          timeScope,
          isComputCommonProp,
          _moveAmount
    ...
    if (moveDir === 'min' || moveDir === 'all') {
      var backwardArr = timeSpeculation_backrward(
        targetTickArr[0].value,
        timeScope.start
      );

      if (backwardArr.length > 1) {
        var _arr = createTickers(
          backwardArr,
          timeScope,
          isComputCommonProp,
          _moveAmount
    ...
    if (isComputCommonProp) {
      ...
      for (
        var _iterator = _createForOfIteratorHelperLoose(targetTickArr), _step;
        !(_step = _iterator()).done;
  ...
  var updateDisplayTicks = function updateDisplayTicks(
    targetTickArr,
    newTickArr
  ) {
  ...
  var computTickCommonProp = function computTickCommonProp(
    range,
    width,
    totalArrLength
  ) {
  ...
  var computDataPixTick = function computDataPixTick(
    item,
    range,
    index,
    dataWidth,
  ...
  var createTickers = function createTickers(
    arr,
    range,
    isComputCommonProp,
    moveAmount
    ...
    for (
      var _iterator2 = _createForOfIteratorHelperLoose(arr), _step2;
  ...
  var createDisplayTickers = function createDisplayTickers(arr) {
    ...
    while (true) {
      if (result.length > netLineMaxCount) {
        ...
        for (
          var _iterator3 = _createForOfIteratorHelperLoose(result), _step3;
  ...
  var createNetLines = function createNetLines(displaytickItems) {
    ...
    for (
      var _iterator4 = _createForOfIteratorHelperLoose(displaytickItems),
        _step4;
  ...
  var createDisplayTickersByDate = function createDisplayTickersByDate(
    tickArr,
    ...
    for (
      ...
      if (
        _item.count > initArgs.netLineMinCount &&
        _item.count < initArgs.netLineMaxCount
      ) {
        isFind = true;
    ...
    for (
      var _iterator6 = _createForOfIteratorHelperLoose(displayTickArr1), _step6;
  ...
  var getTickWithFormated = function getTickWithFormated(tickArr, xCondition) {
    ...
    currentItem.displayValue = xCondition.type.formatter(
      ...
      config == null ? void 0 : config.language,
      config.timeZone.displayTimeZone
    );
  ...
  var createAxisData = function createAxisData() {
    ...
    */
     ...
     * 粗糙时间范围
     */
    var _flexTimeScope = currentTimeType.getInitTimeScope(
    ...
    var _timeInteger = currentTimeType.roundingFunction(
      _flexTimeScope.end,
      config.timeZone.displayTimeZone
    );
    /* 对齐整数的时间组 */

    var realTimeArr = timeSpeculation_backrward(
      _timeInteger,
      _flexTimeScope == null ? void 0 : _flexTimeScope.start
    );
    /**
     * 当前时间范围
     */
    ...
    var displayTickRoundValuesArray = findRoundTimeCountFromArray(
      _tickerArr,
      config.timeZone.displayTimeZone,
      config.timeFormat,
      'value'
  ...
  var moveAxis = function moveAxis(start, stop, isSaveScope) {
    ...
    if (
      ...
      config != null &&
      (_config$data = config.data) != null &&
      (_config$data$dynamicD = _config$data.dynamicData) != null &&
      _config$data$dynamicD.stopUserOperateWhenLoading
    ) {
      return;
    }
    ...
    if (isFinishedInit) {
      ...
      if (displayTickRoundValuesArray === null) {
         ...
         * 旧显示tick的交集
         */
        var resultInterDisplayArr = findIntersection(
          displayTickArr,
          _currentTimeScope
        );
  ...
  var scale = function scale(point, precent, movement) {
    ...
    if (
      ...
      candleObj.data.isFetchingData &&
      config != null &&
      (_config$data2 = config.data) != null &&
      (_config$data2$dynamic = _config$data2.dynamicData) != null &&
      _config$data2$dynamic.stopUserOperateWhenLoading
    ) {
      return;
    }
  ...
  var tooltipUpdate = function tooltipUpdate() {
    if (isFinishedInit && tooltipIsShow) {
      ...
      _tooltipState.position.x =
        ((_tooltipState$related = _tooltipState.relatedTickItem) == null
          ? void 0
          : _tooltipState$related.cPosition.x) + x;
  ...
  var updateAxisSates = function updateAxisSates(
    viewWidth,
    viewHeight,
    yAxisLabelSpace
  ) {
...
var useyAxis = function useyAxis(args, xAxis) {
  ...
  var updateAxisSates = function updateAxisSates(
    ...
    setlineSize({
      height:
        viewHeight - getSpaceSize(xAxis.initArgs.labelSpace, viewHeight) + 1,
      size: initArgs.lineSize,
    });
    ...
    setcurrentDataPositionofStart(
      new _bigNumber(dataScope.start).minus('0').toString()
    );
  ...
  var expandDataSpanceEdge = function expandDataSpanceEdge(input) {
    ...
    var currentDataSpace = new _bigNumber(input.end)
      .minus(input.start)
      .toString();

    var _expandAmount = new _bigNumber(currentDataSpace).times(
      initArgs.displayPadding
    );

    currentDataSpace = new _bigNumber(currentDataSpace)
      .plus(_expandAmount)
      .toString();
    result.start = new _bigNumber(input.start)
      .minus(new _bigNumber(_expandAmount).div(2))
      .toString();
    result.end = new _bigNumber(input.end)
      .plus(new _bigNumber(_expandAmount).div(2))
      .toString();
    return {
      dataScope: result,
  ...
  var expandDataSpanceEdgePIX = function expandDataSpanceEdgePIX(input) {
    ...
    var currentDataSpace = new _bigNumber(input.start)
      .minus(input.end)
      .toString();
    ...
    currentDataSpace = new _bigNumber(currentDataSpace)
      ...
      .toString();
    result.start = Number(
      new _bigNumber(input.start)
        .plus(new _bigNumber(_expandAmount).div(2))
        .toString()
    );
    result.end = Number(
      new _bigNumber(input.end)
        .minus(new _bigNumber(_expandAmount).div(2))
        .toString()
    );
    return {
  ...
  var getTickSeed = function getTickSeed() {
    ...
    var intGetPar = '10';
    var tickCount = '8';
    var startInteger = roundToNearestTenBigNumber(
      scope.start,
      Number(intGetPar)
    );
    ...
    while (true) {
      ...
      tickCount = new _bigNumber(scDf)
        .div(step)
        .toFixed()
        .toString(); //看算出来的数量是否大于最大数量，大于的话就继续算
      ...
      if (new _bigNumber(tickCount).gt(initArgs.netLineMaxCount)) {
        ...
        if (postStep.length > step.length) {
          ...
          startInteger = roundToNearestTenBigNumber(
            scope.start,
            Number(intGetPar)
          );
        }
    ...
    for (var i = 0; i < Number(tickCount); i++) {
      //startInteger + (step * i)
      resultTickArr.push(
        new _bigNumber(startInteger)
          .plus(new _bigNumber(step).times(i))
          .toString()
      );
    }
  ...
  var computDisplayTicks = function computDisplayTicks(tickSeed) {
    ...
    for (
      var _iterator = _createForOfIteratorHelperLoose(tickSeed), _step;
      !(_step = _iterator()).done;
      ...
      result.push({
        ...
        value: item,
        displayValue: new _bigNumber(shiftNumber(item, -_shiftLength)).toFixed(
          displayFix
        ),
      });
      index++;
  ...
  var computDisplayLines = function computDisplayLines(tickSeed) {
    ...
    for (
      var _iterator2 = _createForOfIteratorHelperLoose(tickSeed), _step2;
      !(_step2 = _iterator2()).done;
  ...
  var tooltipMove = function tooltipMove(position, isShowTooltip) {
    ...
    var value = new _bigNumber(currentDataScope.start)
      .plus(new _bigNumber(currentDataSpace).times(pre))
      .toString();
    var _tooltipState = {
      position: {
        x: 0,
      ...
      length: linePosition.x,
      value: value,
      displayValue: new _bigNumber(shiftNumber(value, -_shiftLength)).toFixed(
        displayFix
      ),
...
var useCandleHook = function useCandleHook(args, xAxis, yAxis, baseConfig) {
  ...
  var determineTimeSpaceConsistent = function determineTimeSpaceConsistent(
    data
  ) {
    if (data.length === 1) {
      return 'smaller';
  ...
  var mergeData = function mergeData(data) {
    ...
    for (var i = data.length - 1; i > -1; i--) {
      var item = data[i];
      var time = xAxis.data.currentTimeType.roundingFunction(
      ...
      if (
        ...
        if (
          ...
          ] = _currentCandleStick; //result.push(_currentCandleStick);
        }
  ...
  var putDataIntoAllComputedCandleData = function putDataIntoAllComputedCandleData(
    data
  ) {
    var _displayCandleMaxMin = {
      /**
  ...
  var getDataSpaceFromNumberScope = function getDataSpaceFromNumberScope(
    dataScope,
    start,
    end
  ) {
  ...
  var seAllDataDateToUserConfigedGMT = function seAllDataDateToUserConfigedGMT(
    data
  ) {
    for (
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                //清空堆数据
                Object.keys(allComputedCandleData.current).forEach(function(
                  key
                ) {
                ...
                _timeInteger = xAxis.data.currentTimeType.roundingFunction(
                  endTime,
                  0
                );
                timeZoneD = 0;
                ...
                startTime = xAxis.data.currentTimeType.backwardTimeUnit(
                  endTime,
                  preTime,
                  baseConfig.timeZone.displayTimeZone
                );
                _context.next = 33;
                return initArgs.dynamicData.dataFetchCallback(
                  xAxis.data.currentTimeType.name,
                  startTime,
                  endTime
                );
              ...
              case 33:
                ...
                heightPixVolumArea = getSpaceSize(
                  (_initArgs$candleStyle = initArgs.candleStyles) == null
                    ? void 0
                    : (_initArgs$candleStyle2 =
                        _initArgs$candleStyle.volumChart) == null
                    ? void 0
                    : _initArgs$candleStyle2.volumeChartHeight,
  ...
  var lunchDynamicData = /*#__PURE__*/ (function() {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee2(endTime) {
          ...
          while (1) {
            switch ((_context2.prev = _context2.next)) {
              ...
              case 14:
                ...
                intTime = anyTimeToGMT0000ToTarget(
  ...
  var initStaticData = function initStaticData() {
    ...
    var _orgCandleData = seAllDataDateToUserConfigedGMT(
    ...
    for (
      var _iterator3 = _createForOfIteratorHelperLoose(result.data), _step3;
      !(_step3 = _iterator3()).done;
    ...
    var heightPixVolumArea = getSpaceSize(
      (_initArgs$candleStyle3 = initArgs.candleStyles) == null
        ? void 0
        : (_initArgs$candleStyle4 = _initArgs$candleStyle3.volumChart) == null
        ? void 0
        : _initArgs$candleStyle4.volumeChartHeight,
      xAxis.data.linePosition.y
    );
    setvolumChartPixHeight(heightPixVolumArea);
    setorgCandleData(_orgCandleData);
  ...
  var updatePartialCandleData = function updatePartialCandleData() {
    ...
    for (
      var _iterator4 = _createForOfIteratorHelperLoose(result.data), _step4;
      !(_step4 = _iterator4()).done;
      ...
      if (isQuickUpdateing_current) {
        ...
        if (
          Number(
            (_item$wickPixPosition = item.wickPixPosition) == null
              ? void 0
              : _item$wickPixPosition.y
          ) +
          ...
          orgMaxMiny.start =
            Number(
              (_item$wickPixPosition2 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition2.y
            ) + Number(item.wickLength);
        } //求（像素）y最小值

        if (
          Number(
            (_item$wickPixPosition3 = item.wickPixPosition) == null
              ? void 0
              : _item$wickPixPosition3.y
          ) < orgMaxMiny.end
        ) {
          var _item$wickPixPosition4;

          orgMaxMiny.end = Number(
            (_item$wickPixPosition4 = item.wickPixPosition) == null
              ? void 0
              : _item$wickPixPosition4.y
          );
        }
      } else {
        var _item$candlePixPositi,
          _item$wickPixPosition5,
          _item$candlePixPositi3,
          _item$wickPixPosition7;

        if (
          Math.max(
            Number(
              (_item$candlePixPositi = item.candlePixPosition) == null
                ? void 0
                : _item$candlePixPositi.y
            ) + Number(item.candleLength),
            Number(
              (_item$wickPixPosition5 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition5.y
            ) + Number(item.wickLength)
          ) > orgMaxMiny.start
        ) {
          ...
          orgMaxMiny.start = Math.max(
            Number(
              (_item$candlePixPositi2 = item.candlePixPosition) == null
                ? void 0
                : _item$candlePixPositi2.y
            ) + Number(item.candleLength),
            Number(
              (_item$wickPixPosition6 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition6.y
            ) + Number(item.wickLength)
          );
        } //求（像素）y最小值
        ...
        if (
          Math.min(
            Number(
              (_item$candlePixPositi3 = item.candlePixPosition) == null
                ? void 0
                : _item$candlePixPositi3.y
            ),
            Number(
              (_item$wickPixPosition7 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition7.y
            )
          ) < orgMaxMiny.end
        ) {
          ...
          orgMaxMiny.end = Math.min(
            Number(
              (_item$candlePixPositi4 = item.candlePixPosition) == null
                ? void 0
                : _item$candlePixPositi4.y
            ),
            Number(
              (_item$wickPixPosition8 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition8.y
            )
          );
        }
      }
  ...
  */
  ...
  var updatePartialCandleDataV3 = function updatePartialCandleDataV3() {
    var onlyUpdatePositionAndScale = function onlyUpdatePositionAndScale(
      _cArr
    ) {
      ...
      var currentScopeDisplayCandleData = findIntersectionCandle(
        barr,
      ...
      while (i < currentScopeDisplayCandleData.length) {
        ...
        if (isQuickUpdateing.current) {
          ...
          if (
            Number(
              (_item$wickPixPosition9 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition9.y
            ) +
              Number(item.wickLength) >
            orgMaxMiny.start
          ) {
            ...
            orgMaxMiny.start =
              Number(
                (_item$wickPixPosition10 = item.wickPixPosition) == null
                  ? void 0
                  : _item$wickPixPosition10.y
              ) + Number(item.wickLength);
          } //求（像素）y最小值

          if (
            Number(
              (_item$wickPixPosition11 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition11.y
            ) < orgMaxMiny.end
          ) {
            var _item$wickPixPosition12;

            orgMaxMiny.end = Number(
              (_item$wickPixPosition12 = item.wickPixPosition) == null
                ? void 0
                : _item$wickPixPosition12.y
            );
          }
        } else {
          var _item$candlePixPositi5,
            _item$wickPixPosition13,
            _item$candlePixPositi7,
            _item$wickPixPosition15;

          if (
            Math.max(
              Number(
                (_item$candlePixPositi5 = item.candlePixPosition) == null
                  ? void 0
                  : _item$candlePixPositi5.y
              ) + Number(item.candleLength),
              Number(
                (_item$wickPixPosition13 = item.wickPixPosition) == null
                  ? void 0
                  : _item$wickPixPosition13.y
              ) + Number(item.wickLength)
            ) > orgMaxMiny.start
          ) {
            ...
            orgMaxMiny.start = Math.max(
              Number(
                (_item$candlePixPositi6 = item.candlePixPosition) == null
                  ? void 0
                  : _item$candlePixPositi6.y
              ) + Number(item.candleLength),
              Number(
                (_item$wickPixPosition14 = item.wickPixPosition) == null
                  ? void 0
                  : _item$wickPixPosition14.y
              ) + Number(item.wickLength)
            );
          } //求（像素）y最小值
          ...
          if (
            Math.min(
              Number(
                (_item$candlePixPositi7 = item.candlePixPosition) == null
                  ? void 0
                  : _item$candlePixPositi7.y
              ),
              Number(
                (_item$wickPixPosition15 = item.wickPixPosition) == null
                  ? void 0
                  : _item$wickPixPosition15.y
              )
            ) < orgMaxMiny.end
          ) {
            ...
            orgMaxMiny.end = Math.min(
              Number(
                (_item$candlePixPositi8 = item.candlePixPosition) == null
                  ? void 0
                  : _item$candlePixPositi8.y
              ),
              Number(
                (_item$wickPixPosition16 = item.wickPixPosition) == null
                  ? void 0
                  : _item$wickPixPosition16.y
              )
            );
          }
        }
    ...
    var updateAndAppendNewCandle = function updateAndAppendNewCandle() {
      ...
      if (xAxis.data.tickArr[0].value !== _totalCandleDisplayArr[0].time) {
        ...
        while (
          ...
          var _item2 =
            allComputedCandleData.current[xAxis.data.tickArr[index].value];
      ...
      if (
        ...
        while (
          typeof xAxis.data.tickArr[_index] !== 'undefined' &&
          xAxis.data.tickArr[_index].value >
            _totalCandleDisplayArr[_totalCandleDisplayArr.length - 1].time
        ) {
          var _item3 =
            allComputedCandleData.current[xAxis.data.tickArr[_index].value];
      ...
      var _displayCandleData = []
        .concat(backwardDCArr, _totalCandleDisplayArr, forwardDCArr)
        .sort(function(a, b) {
          return Number(a.time) - Number(b.time);
        });
      ...
      if (
        ...
        if (
          ...
          var i = 0;
          var starttime = xAxis.data.currentTimeType.backwardTimeUnit(
            Number(currentScopeDisplayCandleData[0].time),
            rangeNamber,
            0
          );
        ...
        if (
          ...
          var endTime = xAxis.data.currentTimeType.forwardTimeUnit(
            Number(
              currentScopeDisplayCandleData[
                currentScopeDisplayCandleData.length - 1
              ].time
  ...
  var reComputAllDisplayedCandleData = function reComputAllDisplayedCandleData() {
    ...
    for (
      var _iterator6 = _createForOfIteratorHelperLoose(result.data), _step6;
      !(_step6 = _iterator6()).done;
  ...
  var checkDynamicData = /*#__PURE__*/ (function() {
    var _ref3 = _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee3(data) {
              ...
              case 2:
                ...
                if (
                  ...
                  if (typeof data !== 'undefined') {
                    if (
                      Number(data[0].time) -
                        Number(xAxis.data.tickArr[0].value) >
                      0
                    ) {
                      //往下拉取数据
  ...
  var updateStreamData = function updateStreamData() {
    ...
    var currentRoundTime =
      (_xAxis$data$currentTi = xAxis.data.currentTimeType) == null
        ? void 0
        : _xAxis$data$currentTi.roundingFunction(
            Number(time),
            baseConfig.timeZone.displayTimeZone
          );
    ...
    if (
      currentRoundTime ===
      ((_latestCandleItem2 = _latestCandleItem) == null
        ? void 0
        : _latestCandleItem2.time)
    ) {
      //是否为快速合并模式
      ...
      currentRoundTime >
      Number(
        (_latestCandleItem3 = _latestCandleItem) == null
          ? void 0
          : _latestCandleItem3.time
      )
    ) {
      //如果是下一个时间刻度
      //是否为快速合并模式
    ...
    if (orgCandleData.length !== 0 && displayCandleData.length !== 0) {
      ...
      if (latestCandleItem === null) {
        if (isStaticData) {
          ...
          var intTime = xAxis.data.currentTimeType.roundingFunction(
      ...
      if (typeof dataItem !== 'undefined') {
        ...
        var _latestVolumeToolTip = {
          ...
          relatedTickItem: null,
          size: getSpaceSize(
            (_initArgs$candleStyle5 = initArgs.candleStyles.volumChart) == null
              ? void 0
              : _initArgs$candleStyle5.currentPriceTooltip.lineSize,
            viewSize.width
          ),
        };
  ...
  var updateLatestdisplayLatestCandle = function updateLatestdisplayLatestCandle() {
    if (displayLatestCandle !== null) {
      ...
      var _displayLatestCandle = computSingalCandledata(
        _extends({}, displayLatestCandle),
        edgeScope.dataScope,
        displayCandleMaxMin
      );
      ...
      var _latestdisplayLatestVolume = {
        ...
        relatedTickItem: null,
        size: getSpaceSize(
          (_initArgs$candleStyle6 = initArgs.candleStyles.volumChart) == null
            ? void 0
            : _initArgs$candleStyle6.viewLastPriceTooltip.lineSize,
          viewSize.width
        ),
      };
    ...
    function() {
      ...
      if (
        ...
        setcurrentTimeTypeName(
          (_xAxis$data$currentTi2 = xAxis.data.currentTimeType) == null
            ? void 0
            : _xAxis$data$currentTi2.name
        );
        setcurrentTimeZone(baseConfig.timeZone); //如果是静态数据
...
var useCandleView = function useCandleView(args) {
  ...
  var setTimeFormat = function setTimeFormat( //类型
    value, //数据所在时区
    dataSourceTimeZone, //请求数据时将时间参数调整在哪个时区
    fetchConditionTimeZone, //显示时调整到哪个时区
    displayTimeZone
  ) {
    ...
    function() {
      if (
        ...
        xAxisObj.funcs.initAxisSates(
          ...
          canvasWidth,
          canvasHeight,
          (_initArgs$yAxis = initArgs.yAxis) == null
            ? void 0
            : _initArgs$yAxis.labelSpace
        ); //初始化y轴
        ...
        xAxisObj.funcs.updateAxisSates(
          canvasWidth,
          canvasHeight,
          (_initArgs$yAxis2 = initArgs.yAxis) == null
            ? void 0
            : _initArgs$yAxis2.labelSpace
        );
      } // eslint-disable-next-line react-hooks/exhaustive-deps
    },
    ...
    function() {
      if (xAxisObj.data.isFinishedInit) {
        ...
        xAxisObj.funcs.initAxisSates(
          ...
          canvasWidth,
          canvasHeight,
          (_initArgs$yAxis3 = initArgs.yAxis) == null
            ? void 0
            : _initArgs$yAxis3.labelSpace
        );
      } // eslint-disable-next-line react-hooks/exhaustive-deps
    },
    [
      initArgs.timeFormat,
      (_initArgs$yAxis4 = initArgs.yAxis) == null
        ? void 0
        : _initArgs$yAxis4.labelSpace,
      initArgs == null ? void 0 : initArgs.timeZone,
    ]
  );
  React.useEffect(
    function() {
      if (xAxisObj.data.isFinishedInit) {
        ...
        setdataArea({
          width:
            canvasWidth - getSpaceSize(initArgs.yAxis.labelSpace, canvasWidth),
          height:
            canvasHeight -
...
var drawDash = function drawDash(
  target,
  x1,
  y1,
  x2,
...
var XAxis = function XAxis(_ref2, _ref) {
        ...
        React__default.createElement(
          ...
          React__default.createElement(react.Text, {
            ...
            text: (function() {
              ...
              if (
                typeof CVData.hookObjs.xAxisObj.initArgs.formatter !==
                'undefined'
              ) {
                return CVData.hookObjs.xAxisObj.initArgs.formatter(item);
              }

              return (_item$displayValue = item.displayValue) == null
                ? void 0
                : _item$displayValue.toString();
            })(),
            resolution: 2,
            style: new PIXI.TextStyle({
              ...
              fill: PIXI.utils.string2hex(
                CVData.hookObjs.xAxisObj.initArgs.tickColor
              ),
            }),
          })
        )
  ...
  var makeTooltip = function makeTooltip() {
    var _CVData$hookObjs$xAxi,
      _CVData$hookObjs$xAxi2,
      _tooltipTextRef$curre,
      _CVData$hookObjs$xAxi3,
      _CVData$hookObjs$xAxi4,
      _CVData$hookObjs$xAxi5,
      _CVData$hookObjs$xAxi6,
      _CVData$hookObjs$xAxi7,
      _CVData$hookObjs$xAxi8,
      _CVData$hookObjs$xAxi9,
      _CVData$hookObjs$xAxi10;
    ...
    return React__default.createElement(
      React__default.Fragment,
      null,
      React__default.createElement(DashedLine, {
        color: PIXI.utils.string2hex(
          CVData.hookObjs.xAxisObj.initArgs.tooltip.color
        ),
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$xAxi = CVData.hookObjs.xAxisObj.initArgs.tooltip) ==
            null
            ? void 0
            : (_CVData$hookObjs$xAxi2 = _CVData$hookObjs$xAxi.label) == null
            ? void 0
            : _CVData$hookObjs$xAxi2.backGroundColor
        ),
        size: {
          width:
            ((_tooltipTextRef$curre = tooltipTextRef.current) == null
              ? void 0
              : _tooltipTextRef$curre.width) + labelPadding,
        ...
        position: (function() {
          ...
          if (
            CVData.hookObjs.xAxisObj.data.tooltipState.position.x -
              ((_tooltipTextRef$curre2 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre2.width) /
                2 -
              labelPadding / 2 <
            0
          ) {
            ...
            return {
              x:
                ((_tooltipTextRef$curre3 = tooltipTextRef.current) == null
                  ? void 0
                  : _tooltipTextRef$curre3.width) /
                  2 +
                labelPadding / 2,
              y:
          ...
          if (
            CVData.hookObjs.xAxisObj.data.tooltipState.position.x +
              ((_tooltipTextRef$curre4 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre4.width) /
                2 +
              labelPadding / 2 >
            ...
            return {
              x:
                CVData.hookObjs.xAxisObj.data.lineSize.width -
                ((_tooltipTextRef$curre5 = tooltipTextRef.current) == null
                  ? void 0
                  : _tooltipTextRef$curre5.width) /
                  2 -
                labelPadding / 2,
              y:
                CVData.hookObjs.xAxisObj.data.tooltipState.relatedTickItem
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$xAxi3 =
            CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
            ? void 0
            : (_CVData$hookObjs$xAxi4 = _CVData$hookObjs$xAxi3.label) == null
            ? void 0
            : _CVData$hookObjs$xAxi4.color
        ),
        size: {
          width:
            CVData.hookObjs.xAxisObj.data.tooltipState.relatedTickItem.size,
          height:
            CVData.hookObjs.xAxisObj.data.tooltipState.relatedTickItem.length,
        },
        position: {
          x: CVData.hookObjs.xAxisObj.data.tooltipState.position.x,
          y:
            CVData.hookObjs.xAxisObj.data.tooltipState.relatedTickItem.cPosition
              .y,
        },
        alignX: 'center',
        alignY: 'top',
      ...
      React__default.createElement(react.Text, {
        ...
        x: (function() {
          ...
          if (
            CVData.hookObjs.xAxisObj.data.tooltipState.position.x -
              ((_tooltipTextRef$curre6 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre6.width) /
                2 -
              labelPadding / 2 <
            0
          ) {
            ...
            return (
              ((_tooltipTextRef$curre7 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre7.width) /
                2 +
              labelPadding / 2
            );
          }
          ...
          if (
            CVData.hookObjs.xAxisObj.data.tooltipState.position.x +
              ((_tooltipTextRef$curre8 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre8.width) /
                2 +
              labelPadding / 2 >
            CVData.hookObjs.xAxisObj.data.lineSize.width
          ) {
            ...
            return (
              CVData.hookObjs.xAxisObj.data.lineSize.width -
              ((_tooltipTextRef$curre9 = tooltipTextRef.current) == null
                ? void 0
                : _tooltipTextRef$curre9.width) /
                2 -
              labelPadding / 2
            );
          }
        ...
        y:
          CVData.hookObjs.xAxisObj.data.tooltipState.length +
          CVData.hookObjs.xAxisObj.data.labelSpace / 2,
        text:
          (_CVData$hookObjs$xAxi5 =
            CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
            ? void 0
            : (_CVData$hookObjs$xAxi6 = _CVData$hookObjs$xAxi5.label) == null
            ? void 0
            : _CVData$hookObjs$xAxi6.formatter(
                CVData.hookObjs.xAxisObj.data.tooltipState.relatedTickItem
              ),
        resolution: 2,
        style: new PIXI.TextStyle({
          ...
          fontSize:
            (_CVData$hookObjs$xAxi7 =
              CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
              ? void 0
              : (_CVData$hookObjs$xAxi8 = _CVData$hookObjs$xAxi7.label) == null
              ? void 0
              : _CVData$hookObjs$xAxi8.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$xAxi9 =
              CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
              ? void 0
              : (_CVData$hookObjs$xAxi10 = _CVData$hookObjs$xAxi9.label) == null
              ? void 0
              : _CVData$hookObjs$xAxi10.color
          ),
        }),
      })
    );
  ...
  var xBackground = React.useMemo(
    function() {
      return React__default.createElement(
        ...
        React__default.createElement(Rectangle, {
          color: PIXI.utils.string2hex(
            CVData.hookObjs.xAxisObj.initArgs.backgroundColor
          ),
          size: {
  ...
  var ticks = React.useMemo(
    function() {
      return makeTicks();
    },
    [CVData.hookObjs.xAxisObj.data.displayTickArr]
  );
  var labels = React.useMemo(
    function() {
      return makeLabels();
    },
    [
      CVData.hookObjs.xAxisObj.data.displayTickArr,
      CVData.hookObjs.xAxisObj.initArgs,
    ]
  );
...
var DataTooltop = function DataTooltop(_ref2, _ref) {
  var _CVData$hookObjs$cand73,
    _CVData$hookObjs$cand74,
    _CVData$hookObjs$cand75,
    _CVData$hookObjs$cand76;
  ...
  var makeLastCandleTooltip = function makeLastCandleTooltip() {
    var _CVData$hookObjs$cand,
      _CVData$hookObjs$cand2,
      _CVData$hookObjs$cand3,
      _lastDataTooltipTextR,
      _CVData$hookObjs$cand4,
      _CVData$hookObjs$cand5,
      _CVData$hookObjs$cand6,
      _CVData$hookObjs$cand7,
      _CVData$hookObjs$cand8,
      _CVData$hookObjs$cand9,
      _CVData$hookObjs$cand10,
      _CVData$hookObjs$cand11,
      _CVData$hookObjs$cand12,
      _CVData$hookObjs$cand13,
      _CVData$hookObjs$cand14,
      _CVData$hookObjs$cand15;

    if (
      CVData.hookObjs.candleObj.data.latestCandleItem === null ||
      !(
        (_CVData$hookObjs$cand =
          CVData.hookObjs.candleObj.initArgs.candleStyles) != null &&
        _CVData$hookObjs$cand.currentPriceTooltip.enabled
      ) ||
    ...
    return React__default.createElement(
      ...
      React__default.createElement(DashedLine, {
        color: PIXI.utils.string2hex(
          CVData.hookObjs.candleObj.data.latestCandleItem.candleColor
        ),
        size: CVData.hookObjs.candleObj.data.latestCandleToolTip.size,
        positionStart:
          CVData.hookObjs.candleObj.data.latestCandleToolTip.position,
        positionStop: {
        ...
        dashLength:
          (_CVData$hookObjs$cand2 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : _CVData$hookObjs$cand2.currentPriceTooltip.dashLength,
        spaceLength:
          (_CVData$hookObjs$cand3 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : _CVData$hookObjs$cand3.currentPriceTooltip.spaceLength,
      }),
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          CVData.hookObjs.candleObj.data.latestCandleItem.candleColor
        ...
        size: {
          ...
          height:
            ((_lastDataTooltipTextR = lastDataTooltipTextRef.current) == null
              ? void 0
              : _lastDataTooltipTextR.height) + labelPadding,
        },
        position: {
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand4 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand5 =
                _CVData$hookObjs$cand4.currentPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand6 = _CVData$hookObjs$cand5.label) == null
            ? void 0
            : _CVData$hookObjs$cand6.color
        ),
        size: {
      ...
      React__default.createElement(react.Text, {
        ...
        x:
          CVData.hookObjs.yAxisObj.data.linePosition.x +
          CVData.hookObjs.yAxisObj.data.tickLength * 2,
        y: CVData.hookObjs.candleObj.data.latestCandleToolTip.position.y,
        text:
          (_CVData$hookObjs$cand7 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : (_CVData$hookObjs$cand8 =
                _CVData$hookObjs$cand7.currentPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand9 = _CVData$hookObjs$cand8.label) == null
            ? void 0
            : _CVData$hookObjs$cand9.formatter(
                CVData.hookObjs.candleObj.data.latestCandleToolTip
              ),
        resolution: 2,
        style: new PIXI.TextStyle({
          fontSize:
            (_CVData$hookObjs$cand10 =
              ...
              ? void 0
              : (_CVData$hookObjs$cand11 =
                  _CVData$hookObjs$cand10.currentPriceTooltip) == null
              ? void 0
              : (_CVData$hookObjs$cand12 = _CVData$hookObjs$cand11.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand12.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$cand13 =
              CVData.hookObjs.candleObj.initArgs.candleStyles) == null
              ? void 0
              : (_CVData$hookObjs$cand14 =
                  _CVData$hookObjs$cand13.currentPriceTooltip) == null
              ? void 0
              : (_CVData$hookObjs$cand15 = _CVData$hookObjs$cand14.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand15.color
          ),
        }),
      })
    );
  ...
  var makeLatestCandleToolTip = function makeLatestCandleToolTip() {
    var _CVData$hookObjs$cand16,
      _CVData$hookObjs$cand17,
      _CVData$hookObjs$cand18,
      _CVData$hookObjs$cand19,
      _lastDataTooltipTextR2,
      _CVData$hookObjs$cand20,
      _CVData$hookObjs$cand21,
      _CVData$hookObjs$cand22,
      _CVData$hookObjs$cand23,
      _CVData$hookObjs$cand24,
      _CVData$hookObjs$cand25,
      _CVData$hookObjs$cand26,
      _CVData$hookObjs$cand27,
      _CVData$hookObjs$cand28,
      _CVData$hookObjs$cand29,
      _CVData$hookObjs$cand30,
      _CVData$hookObjs$cand31,
      _CVData$hookObjs$cand32,
      _CVData$hookObjs$cand33,
      _CVData$hookObjs$cand34;

    if (
      !(
        (_CVData$hookObjs$cand16 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) != null &&
        _CVData$hookObjs$cand16.viewLastPriceTooltip.enabled
      ) ||
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand17 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand18 =
                _CVData$hookObjs$cand17.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand19 = _CVData$hookObjs$cand18.label) == null
            ? void 0
            : _CVData$hookObjs$cand19.backGroundColor
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.labelSpace,
          height:
            ((_lastDataTooltipTextR2 = lastDataTooltipTextRef2.current) == null
              ? void 0
              : _lastDataTooltipTextR2.height) + labelPadding,
        },
        position: {
          x: CVData.hookObjs.yAxisObj.data.linePosition.x,
          y:
            CVData.hookObjs.candleObj.data.latestdisplayLatestCandle.position.y,
        },
        alignX: 'left',
        alignY: 'center',
        opacity:
          (_CVData$hookObjs$cand20 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand21 =
                _CVData$hookObjs$cand20.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand22 = _CVData$hookObjs$cand21.label) == null
            ? void 0
            : _CVData$hookObjs$cand22.backGroundAlpha,
      }),
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand23 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand24 =
                _CVData$hookObjs$cand23.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand25 = _CVData$hookObjs$cand24.label) == null
            ? void 0
            : _CVData$hookObjs$cand25.color
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      React__default.createElement(react.Text, {
        ...
        text:
          (_CVData$hookObjs$cand26 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand27 =
                _CVData$hookObjs$cand26.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand28 = _CVData$hookObjs$cand27.label) == null
            ? void 0
            : _CVData$hookObjs$cand28.formatter(
                CVData.hookObjs.candleObj.data.latestdisplayLatestCandle
              ),
        resolution: 2,
        style: new PIXI.TextStyle({
          fontSize:
            (_CVData$hookObjs$cand29 =
              ...
              ? void 0
              : (_CVData$hookObjs$cand30 =
                  _CVData$hookObjs$cand29.viewLastPriceTooltip) == null
              ? void 0
              : (_CVData$hookObjs$cand31 = _CVData$hookObjs$cand30.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand31.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$cand32 =
              CVData.hookObjs.candleObj.initArgs.candleStyles) == null
              ? void 0
              : (_CVData$hookObjs$cand33 =
                  _CVData$hookObjs$cand32.viewLastPriceTooltip) == null
              ? void 0
              : (_CVData$hookObjs$cand34 = _CVData$hookObjs$cand33.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand34.color
          ),
        }),
      })
    );
  ...
  var makeLastVolumeTooltip = function makeLastVolumeTooltip() {
    var _CVData$hookObjs$cand35,
      _CVData$hookObjs$cand36,
      _CVData$hookObjs$cand37,
      _CVData$hookObjs$cand38,
      _CVData$hookObjs$cand39,
      _CVData$hookObjs$cand40,
      _CVData$hookObjs$cand41,
      _lastDataTooltipTextR3,
      _CVData$hookObjs$cand42,
      _CVData$hookObjs$cand43,
      _CVData$hookObjs$cand44,
      _CVData$hookObjs$cand45,
      _CVData$hookObjs$cand46,
      _CVData$hookObjs$cand47,
      _CVData$hookObjs$cand48,
      _CVData$hookObjs$cand49,
      _CVData$hookObjs$cand50,
      _CVData$hookObjs$cand51,
      _CVData$hookObjs$cand52,
      _CVData$hookObjs$cand53;

    if (
      !(
        (_CVData$hookObjs$cand35 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) != null &&
        _CVData$hookObjs$cand35.volumChart.currentPriceTooltip.enabled
      ) ||
      ...
      React__default.createElement(DashedLine, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand36 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : _CVData$hookObjs$cand36.volumChart.currentPriceTooltip.color
        ),
        size: CVData.hookObjs.candleObj.data.latestVolumeToolTip.size,
        positionStart:
          CVData.hookObjs.candleObj.data.latestVolumeToolTip.position,
        positionStop: {
        ...
        dashLength:
          (_CVData$hookObjs$cand37 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : _CVData$hookObjs$cand37.volumChart.currentPriceTooltip.dashLength,
        spaceLength:
          (_CVData$hookObjs$cand38 =
            CVData.hookObjs.candleObj.initArgs.candleStyles) == null
            ? void 0
            : _CVData$hookObjs$cand38.volumChart.currentPriceTooltip
                .spaceLength,
      }),
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand39 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand40 =
                _CVData$hookObjs$cand39.volumChart.currentPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand41 = _CVData$hookObjs$cand40.label) == null
            ? void 0
            : _CVData$hookObjs$cand41.backGroundColor
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.labelSpace,
          height:
            ((_lastDataTooltipTextR3 = lastDataTooltipTextRef3.current) == null
              ? void 0
              : _lastDataTooltipTextR3.height) + labelPadding,
        },
        position: {
          x: CVData.hookObjs.yAxisObj.data.linePosition.x,
          y: CVData.hookObjs.candleObj.data.latestVolumeToolTip.position.y,
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand42 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand43 =
                _CVData$hookObjs$cand42.volumChart.currentPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand44 = _CVData$hookObjs$cand43.label) == null
            ? void 0
            : _CVData$hookObjs$cand44.color
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      React__default.createElement(react.Text, {
        ...
        text:
          (_CVData$hookObjs$cand45 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand46 =
                _CVData$hookObjs$cand45.volumChart.currentPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand47 = _CVData$hookObjs$cand46.label) == null
            ? void 0
            : _CVData$hookObjs$cand47.formatter(
                CVData.hookObjs.candleObj.data.latestVolumeToolTip,
        ...
        style: new PIXI.TextStyle({
          fontSize:
            (_CVData$hookObjs$cand48 =
              ...
              ? void 0
              : (_CVData$hookObjs$cand49 =
                  _CVData$hookObjs$cand48.volumChart.currentPriceTooltip) ==
                null
              ? void 0
              : (_CVData$hookObjs$cand50 = _CVData$hookObjs$cand49.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand50.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$cand51 =
              CVData.hookObjs.candleObj.initArgs.candleStyles) == null
              ? void 0
              : (_CVData$hookObjs$cand52 =
                  _CVData$hookObjs$cand51.volumChart.currentPriceTooltip) ==
                null
              ? void 0
              : (_CVData$hookObjs$cand53 = _CVData$hookObjs$cand52.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand53.color
          ),
        }),
      })
    );
  ...
  var makeLatestVolumeToolTip = function makeLatestVolumeToolTip() {
    var _CVData$hookObjs$cand54,
      _CVData$hookObjs$cand55,
      _CVData$hookObjs$cand56,
      _CVData$hookObjs$cand57,
      _lastDataTooltipTextR4,
      _CVData$hookObjs$cand58,
      _CVData$hookObjs$cand59,
      _CVData$hookObjs$cand60,
      _CVData$hookObjs$cand61,
      _CVData$hookObjs$cand62,
      _CVData$hookObjs$cand63,
      _CVData$hookObjs$cand64,
      _CVData$hookObjs$cand65,
      _CVData$hookObjs$cand66,
      _CVData$hookObjs$cand67,
      _CVData$hookObjs$cand68,
      _CVData$hookObjs$cand69,
      _CVData$hookObjs$cand70,
      _CVData$hookObjs$cand71,
      _CVData$hookObjs$cand72;

    if (
      !(
        (_CVData$hookObjs$cand54 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) != null &&
        _CVData$hookObjs$cand54.volumChart.viewLastPriceTooltip.enabled
      ) ||
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand55 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand56 =
                _CVData$hookObjs$cand55.volumChart.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand57 = _CVData$hookObjs$cand56.label) == null
            ? void 0
            : _CVData$hookObjs$cand57.backGroundColor
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.labelSpace,
          height:
            ((_lastDataTooltipTextR4 = lastDataTooltipTextRef4.current) == null
              ? void 0
              : _lastDataTooltipTextR4.height) + labelPadding,
        },
        position: {
          x: CVData.hookObjs.yAxisObj.data.linePosition.x,
          y:
            CVData.hookObjs.candleObj.data.latestdisplayLatestVolume.position.y,
        },
        alignX: 'left',
        alignY: 'center',
        opacity:
          (_CVData$hookObjs$cand58 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand59 =
                _CVData$hookObjs$cand58.volumChart.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand60 = _CVData$hookObjs$cand59.label) == null
            ? void 0
            : _CVData$hookObjs$cand60.backGroundAlpha,
      }),
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$cand61 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand62 =
                _CVData$hookObjs$cand61.volumChart.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand63 = _CVData$hookObjs$cand62.label) == null
            ? void 0
            : _CVData$hookObjs$cand63.color
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      React__default.createElement(react.Text, {
        ...
        text:
          (_CVData$hookObjs$cand64 =
            ...
            ? void 0
            : (_CVData$hookObjs$cand65 =
                _CVData$hookObjs$cand64.volumChart.viewLastPriceTooltip) == null
            ? void 0
            : (_CVData$hookObjs$cand66 = _CVData$hookObjs$cand65.label) == null
            ? void 0
            : _CVData$hookObjs$cand66.formatter(
                CVData.hookObjs.candleObj.data.latestdisplayLatestVolume,
                CVData.initArgs.language
              ),
        resolution: 2,
        style: new PIXI.TextStyle({
          fontSize:
            (_CVData$hookObjs$cand67 =
              ...
              ? void 0
              : (_CVData$hookObjs$cand68 =
                  _CVData$hookObjs$cand67.volumChart.viewLastPriceTooltip) ==
                null
              ? void 0
              : (_CVData$hookObjs$cand69 = _CVData$hookObjs$cand68.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand69.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$cand70 =
              CVData.hookObjs.candleObj.initArgs.candleStyles) == null
              ? void 0
              : (_CVData$hookObjs$cand71 =
                  _CVData$hookObjs$cand70.volumChart.viewLastPriceTooltip) ==
                null
              ? void 0
              : (_CVData$hookObjs$cand72 = _CVData$hookObjs$cand71.label) ==
                null
              ? void 0
              : _CVData$hookObjs$cand72.color
          ),
        }),
      })
    );
  ...
  var latestCandleToolTip = React.useMemo(
    function() {
      return makeLatestCandleToolTip();
    },
    [
      _extends({}, CVData.hookObjs.candleObj.data.latestdisplayLatestCandle),
      updateTemp,
      _extends(
        {},
        (_CVData$hookObjs$cand73 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) == null
          ? void 0
          : _CVData$hookObjs$cand73.viewLastPriceTooltip
      ),
    ]
  );
  var lastCandleTooltip = React.useMemo(
    function() {
      return makeLastCandleTooltip();
    },
    [
      _extends({}, CVData.hookObjs.candleObj.data.latestCandleToolTip),
      updateTemp,
      _extends(
        {},
        (_CVData$hookObjs$cand74 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) == null
          ? void 0
          : _CVData$hookObjs$cand74.currentPriceTooltip
      ),
    ]
  );
  var LastVolumeTooltip = React.useMemo(
    function() {
      return makeLastVolumeTooltip();
    },
    [
      _extends({}, CVData.hookObjs.candleObj.data.latestVolumeToolTip),
      updateTemp,
      _extends(
        {},
        (_CVData$hookObjs$cand75 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) == null
          ? void 0
          : _CVData$hookObjs$cand75.volumChart.currentPriceTooltip
      ),
    ]
  ); //

  var LatestVolumeToolTip = React.useMemo(
    function() {
      return makeLatestVolumeToolTip();
    },
    [
      _extends({}, CVData.hookObjs.candleObj.data.latestdisplayLatestVolume),
      updateTemp,
      _extends(
        {},
        (_CVData$hookObjs$cand76 =
          CVData.hookObjs.candleObj.initArgs.candleStyles) == null
          ? void 0
          : _CVData$hookObjs$cand76.volumChart.viewLastPriceTooltip
      ),
    ]
  );
  return React__default.createElement(
...
var YAxis = function YAxis(_ref2, _ref) {
      ...
      result.push(
        React__default.createElement(react.Text, {
          ...
          style: new PIXI.TextStyle({
            ...
            fill: PIXI.utils.string2hex(
              CVData.hookObjs.yAxisObj.initArgs.tickColor
            ),
          }),
        })
      );
  ...
  var makeTooltip = function makeTooltip() {
    var _CVData$hookObjs$yAxi,
      _CVData$hookObjs$yAxi2,
      _tooltipTextRef$curre,
      _CVData$hookObjs$yAxi3,
      _CVData$hookObjs$yAxi4,
      _CVData$hookObjs$yAxi5,
      _CVData$hookObjs$yAxi6,
      _CVData$hookObjs$yAxi7,
      _CVData$hookObjs$yAxi8,
      _CVData$hookObjs$yAxi9,
      _CVData$hookObjs$yAxi10;
    ...
    return React__default.createElement(
      ...
      React__default.createElement(DashedLine, {
        color: PIXI.utils.string2hex(
          CVData.hookObjs.yAxisObj.initArgs.tooltip.color
        ),
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$yAxi = CVData.hookObjs.yAxisObj.initArgs.tooltip) ==
            null
            ? void 0
            : (_CVData$hookObjs$yAxi2 = _CVData$hookObjs$yAxi.label) == null
            ? void 0
            : _CVData$hookObjs$yAxi2.backGroundColor
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.labelSpace,
          height:
            ((_tooltipTextRef$curre = tooltipTextRef.current) == null
              ? void 0
              : _tooltipTextRef$curre.height) + labelPadding,
        },
        position: {
          x: CVData.hookObjs.yAxisObj.data.linePosition.x,
          y: CVData.hookObjs.yAxisObj.data.tooltipState.position.y,
      ...
      React__default.createElement(Rectangle, {
        color: PIXI.utils.string2hex(
          (_CVData$hookObjs$yAxi3 =
            CVData.hookObjs.yAxisObj.initArgs.tooltip) == null
            ? void 0
            : (_CVData$hookObjs$yAxi4 = _CVData$hookObjs$yAxi3.label) == null
            ? void 0
            : _CVData$hookObjs$yAxi4.color
        ),
        size: {
          width: CVData.hookObjs.yAxisObj.data.tickLength,
      ...
      React__default.createElement(react.Text, {
        ...
        text:
          (_CVData$hookObjs$yAxi5 =
            CVData.hookObjs.yAxisObj.initArgs.tooltip) == null
            ? void 0
            : (_CVData$hookObjs$yAxi6 = _CVData$hookObjs$yAxi5.label) == null
            ? void 0
            : _CVData$hookObjs$yAxi6.formatter(
        ...
        style: new PIXI.TextStyle({
          fontSize:
            (_CVData$hookObjs$yAxi7 =
              CVData.hookObjs.yAxisObj.initArgs.tooltip) == null
              ? void 0
              : (_CVData$hookObjs$yAxi8 = _CVData$hookObjs$yAxi7.label) == null
              ? void 0
              : _CVData$hookObjs$yAxi8.fontsize,
          fill: PIXI.utils.string2hex(
            (_CVData$hookObjs$yAxi9 =
              CVData.hookObjs.yAxisObj.initArgs.tooltip) == null
              ? void 0
              : (_CVData$hookObjs$yAxi10 = _CVData$hookObjs$yAxi9.label) == null
              ? void 0
              : _CVData$hookObjs$yAxi10.color
          ),
        }),
      })
    );
  ...
  var yLabels = React.useMemo(
    function() {
      return makeLabels();
    },
    [
      CVData.hookObjs.yAxisObj.data.displayTickArr,
      CVData.hookObjs.yAxisObj.initArgs,
    ]
  );
  /* 创建ToolTip */
  ...
  return React__default.createElement(
    ...
    yTicks,
    yLabels,
    React__default.createElement(DataToolTip, null),
    tooltip
  );
}; //使用memo不让其因为上级节点的更新而频繁更新
...
var Data = function Data(_ref2, _ref) {
  ...
  var getColor = function getColor(status, type) {
    if (status === 'rise' && type === 'wick') {
      ...
      return (_CVData$initArgs$data = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data2 = _CVData$initArgs$data.candleStyles) == null
        ? void 0
        : _CVData$initArgs$data2.wickRiseColor;
    }

    if (status === 'fall' && type === 'wick') {
      var _CVData$initArgs$data3, _CVData$initArgs$data4;

      return (_CVData$initArgs$data3 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data4 = _CVData$initArgs$data3.candleStyles) == null
        ? void 0
        : _CVData$initArgs$data4.wickFallColor;
    }

    if (status === 'rise' && type === 'candle') {
      var _CVData$initArgs$data5, _CVData$initArgs$data6;

      return (_CVData$initArgs$data5 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data6 = _CVData$initArgs$data5.candleStyles) == null
        ? void 0
        : _CVData$initArgs$data6.candleRiseColor;
    }

    if (status === 'fall' && type === 'candle') {
      var _CVData$initArgs$data7, _CVData$initArgs$data8;

      return (_CVData$initArgs$data7 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data8 = _CVData$initArgs$data7.candleStyles) == null
        ? void 0
        : _CVData$initArgs$data8.candleFallColor;
    }
  ...
  var candle = React.useMemo(
    ...
    [
      ...
      _extends({}, CVData.initArgs.timeZone),
    ]
  );
  var wick = React.useMemo(
    function() {
      if (CVData.hookObjs.candleObj.data.displayCandleData.length === 0) {
        return null;
      }
...
var NetLines = function NetLines(_ref2, _ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(React__default.Fragment, null, netLinesx)
    ),
    netLinesy
  );
}; //使用memo不让其因为上级节点的更新而频繁更新
    ...
    var _loop = function _loop() {
      ...
      var alpha =
        (_CVData$hookObjs$cand =
          CVData.hookObjs.candleObj.initArgs.candleStyles) == null
          ? void 0
          : (_CVData$hookObjs$cand2 = _CVData$hookObjs$cand.volumChart) == null
          ? void 0
          : _CVData$hookObjs$cand2.alpha;
      var currentHeight =
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              LANGUAGES[CVData.initArgs.language].timeFormat[
                (_CVData$hookObjs$xAxi =
                  CVData.hookObjs.xAxisObj.data.currentTimeType) == null
                  ? void 0
                  : _CVData$hookObjs$xAxi.lang
              ]
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Date:'),
            React__default.createElement(
              'label',
              null,
              (_CVData$hookObjs$xAxi2 =
                CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
                ? void 0
                : (_CVData$hookObjs$xAxi3 = _CVData$hookObjs$xAxi2.label) ==
                  null
                ? void 0
                : _CVData$hookObjs$xAxi3.formatter(
            ...
            React__default.createElement(
              ...
              null,
              'GMT +',
              (_CVData$initArgs$time = CVData.initArgs.timeZone) == null
                ? void 0
                : _CVData$initArgs$time.displayTimeZone
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Open:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(item.open).toFixed(3)))
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Close:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(item.close).toFixed(3)))
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'High:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(item.high).toFixed(3)))
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Low:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(item.low).toFixed(3)))
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Volume:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(item.volume).toFixed(3)))
            )
          )
        )
      );
    } else if (CVData.hookObjs.candleObj.data.latestCandleItem !== null) {
      var _CVData$hookObjs$xAxi4,
        _CVData$hookObjs$xAxi5,
        _CVData$hookObjs$xAxi6,
        _CVData$initArgs$time2;
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              (_CVData$hookObjs$xAxi5 =
                CVData.hookObjs.xAxisObj.initArgs.tooltip) == null
                ? void 0
                : (_CVData$hookObjs$xAxi6 = _CVData$hookObjs$xAxi5.label) ==
                  null
                ? void 0
                : _CVData$hookObjs$xAxi6.formatter({
            ...
            React__default.createElement(
              ...
              null,
              'GMT +',
              (_CVData$initArgs$time2 = CVData.initArgs.timeZone) == null
                ? void 0
                : _CVData$initArgs$time2.displayTimeZone
            )
          ),
          React__default.createElement(
            'div',
            ...
            React__default.createElement(
              ...
              null,
              thousandsSplit(
                Number(new _bigNumber(currentItem.open).toFixed(3))
              )
            )
          ),
          React__default.createElement(
            'div',
            null,
            React__default.createElement('span', null, 'Current:'),
            React__default.createElement(
              'label',
              null,
              thousandsSplit(
                Number(new _bigNumber(currentItem.close).toFixed(3))
              )
            )
          ),
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              null,
              thousandsSplit(
                Number(new _bigNumber(currentItem.high).toFixed(3))
              )
            )
          ),
          React__default.createElement(
            ...
            React__default.createElement(
              'label',
              null,
              thousandsSplit(Number(new _bigNumber(currentItem.low).toFixed(3)))
            )
          ),
          React__default.createElement(
            'div',
            ...
            React__default.createElement(
              ...
              null,
              thousandsSplit(
                Number(new _bigNumber(currentItem.volume).toFixed(3))
              )
            )
          )
        )
...
var Loading = function Loading(_ref2, _ref) {
  ...
  if (
    (_CVData$initArgs$data = CVData.initArgs.data) != null &&
    (_CVData$initArgs$data2 = _CVData$initArgs$data.dynamicData) != null &&
    _CVData$initArgs$data2.showLoading &&
...
var CandleView = /*#__PURE__*/ React.memo(function(_ref2, _ref) {
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                CVData.funcs.setcanvasBackgroundColor(
                  CVData.initArgs.backgroundColor
                );
  ...
  var onTouchStartContainer = function onTouchStartContainer(event) {
    ...
    if (
      ((_CVData$initArgs$data = CVData.initArgs.data) == null
        ...
        : (_CVData$initArgs$data2 = _CVData$initArgs$data.dynamicData) == null
        ? void 0
        : _CVData$initArgs$data2.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onTouchMoveContainer = function onTouchMoveContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data3 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data4 = _CVData$initArgs$data3.dynamicData) == null
        ? void 0
        : _CVData$initArgs$data4.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onTouchEndtContainer = function onTouchEndtContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data5 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data6 = _CVData$initArgs$data5.dynamicData) == null
        ? void 0
        : _CVData$initArgs$data6.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onMouseEnterContainer = function onMouseEnterContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data7 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data8 = _CVData$initArgs$data7.dynamicData) == null
        ? void 0
        : _CVData$initArgs$data8.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onMouseDownContainer = function onMouseDownContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data9 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data10 = _CVData$initArgs$data9.dynamicData) == null
        ? void 0
        : _CVData$initArgs$data10.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onMouseMoveContainer = function onMouseMoveContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data11 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data12 = _CVData$initArgs$data11.dynamicData) ==
          null
        ? void 0
        : _CVData$initArgs$data12.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onMouseUpContainer = function onMouseUpContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data13 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data14 = _CVData$initArgs$data13.dynamicData) ==
          null
        ? void 0
        : _CVData$initArgs$data14.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onMouseLeaveContainer = function onMouseLeaveContainer(event) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data15 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data16 = _CVData$initArgs$data15.dynamicData) ==
          null
        ? void 0
        : _CVData$initArgs$data16.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
  ...
  var onWheelContainer = function onWheelContainer(e) {
    ...
    //开启了正在加载时阻止用户操作
    if (
      ((_CVData$initArgs$data17 = CVData.initArgs.data) == null
        ? void 0
        : (_CVData$initArgs$data18 = _CVData$initArgs$data17.dynamicData) ==
          null
        ? void 0
        : _CVData$initArgs$data18.stopUserOperateWhenLoading) === true &&
      CVData.hookObjs.candleObj.data.isFetchingData
    ) {
      return;
    }
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(NetLines$1, null),
          React__default.createElement(VolumChart, null),
          React__default.createElement(Data$1, null),
