...
export const TWO: ItimeFormat = {
	...
	getInitTimeScope: function (initTime: string) {
		if (initTime === "now") {
			return { start: +new Date() - 1000 * 60 * 30, end: +new Date() + 1000 * 60 * 30 };
		} else {
			return { start: +new Date(initTime) - 1000 * 60 * 30, end: +new Date(initTime) + 1000 * 60 * 30 };
		}
	},
	formatter: function (value, lan, hourShift) {
		// 获取时间对象
...
export const THREE: ItimeFormat = {
	...
	getInitTimeScope: function (initTime: string) {
		if (initTime === "now") {
			return { start: +new Date() - 1000 * 60 * 60, end: +new Date() + 1000 * 60 * 60 };
		} else {
			return { start: +new Date(initTime) - 1000 * 60 * 60, end: +new Date(initTime) + 1000 * 60 * 60 };
		}
	},
	formatter: function (value, lan, hourShift) {
		// 获取时间对象
...
export const FMIN: ItimeFormat = {
	...
	getInitTimeScope: function (initTime: string) {
		if (initTime === "now") {
			return { start: +new Date() - 1000 * 60 * 50, end: +new Date() + 1000 * 60 * 10 };
		} else {
			return { start: +new Date(initTime) - 1000 * 60 * 50, end: +new Date(initTime) + 1000 * 60 * 10 };
		}
	},
	formatter: function (value, lan, hourShift) {
		// 获取时间对象
