...
import {
  IPixiKlineBatching,
  IPixiShapeDashedLine,
  IPixiShapeRectangle,
  IPixiVolumeBatching,
} from '../interface/basicShapesInterFace';

export const Rectangle = PixiComponent<IPixiShapeRectangle, Graphics>(
  'Rectangle',
  {
    create: () => new Graphics(),
 ...
 * 用于对k线图进行批量绘制的形状
 */
export const KlineBatching = PixiComponent<IPixiKlineBatching, Graphics>(
  'KlineBatching',
  {
    create: () => new Graphics(),
    applyProps: (instance, oldProps, props) => {
 ...
 */
export const VolumeBatching = PixiComponent<IPixiVolumeBatching, Graphics>(
  'VolumeBatching',
  {
    create: () => new Graphics(),
    applyProps: (instance, oldProps, props) => {
      ...
      for (var item of new_props.data) {
        let currentHeight =
          new_props.volumChartPixHeight *
          (Number(item.volume) / new_props.staticMax);
        let size = {
          width: (function() {
            if (!new_props.isDQuickUpdateing) {
...
export const DashedLine = PixiComponent<IPixiShapeDashedLine, Graphics>(
  'DashedLine',
  {
    create: () => new Graphics(),
