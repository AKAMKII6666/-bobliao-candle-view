...
webWorker.addEventListener('message', event => {
  ...
  let _org_displayCandleMaxMin = Object.assign(
    {},
    inputData._org_displayCandleMaxMin
  );
  ...
  let initArgs_candleStyles_wickFallColor =
    inputData.initArgs_candleStyles_wickFallColor;
  let initArgs_candleStyles_candleFallColor =
    inputData.initArgs_candleStyles_candleFallColor;
  let initArgs_candleStyles_wickRiseColor =
    inputData.initArgs_candleStyles_wickRiseColor;
  let initArgs_candleStyles_candleRiseColor =
    inputData.initArgs_candleStyles_candleRiseColor;
  let initArgs_candleStyles_candleWidth =
    inputData.initArgs_candleStyles_candleWidth;
  let initArgs_candleStyles_wickWidth =
    inputData.initArgs_candleStyles_wickWidth;
  let xAxis_data_displayTickCommonpixWidth =
    inputData.xAxis_data_displayTickCommonpixWidth;
  ...
  const getDataSpaceFromNumberScope = function(dataScope, start, end) {
    ...
    let yHeight =
      _viewSize.height -
      getSpaceSize(xAxis_initArgs_labelSpace, _viewSize.height);
  ...
  for (var item of result.data) {
    ...
    if (isQuickUpdateing_current) {
      if (
        Number(
          (_a = item.wickPixPosition) === null || _a === void 0 ? void 0 : _a.y
        ) +
        ...
        orgMaxMiny.start =
          Number(
            (_b = item.wickPixPosition) === null || _b === void 0
              ? void 0
              : _b.y
          ) + Number(item.wickLength);
      }
      ...
      if (
        Number(
          (_c = item.wickPixPosition) === null || _c === void 0 ? void 0 : _c.y
        ) < orgMaxMiny.end
      ) {
        orgMaxMiny.end = Number(
          (_d = item.wickPixPosition) === null || _d === void 0 ? void 0 : _d.y
        );
      }
    } else {
      if (
        Math.max(
          Number(
            (_f = item.candlePixPosition) === null || _f === void 0
              ? void 0
              : _f.y
          ) + Number(item.candleLength),
          Number(
            (_g = item.wickPixPosition) === null || _g === void 0
              ? void 0
              : _g.y
          ) + Number(item.wickLength)
        ) > orgMaxMiny.start
        ...
        orgMaxMiny.start = Math.max(
          Number(
            (_h = item.candlePixPosition) === null || _h === void 0
              ? void 0
              : _h.y
          ) + Number(item.candleLength),
          Number(
            (_j = item.wickPixPosition) === null || _j === void 0
              ? void 0
              : _j.y
          ) + Number(item.wickLength)
        );
      ...
      if (
        Math.min(
          Number(
            (_k = item.candlePixPosition) === null || _k === void 0
              ? void 0
              : _k.y
          ),
          Number(
            (_l = item.wickPixPosition) === null || _l === void 0
              ? void 0
              : _l.y
          )
        ) < orgMaxMiny.end
        ...
        orgMaxMiny.end = Math.min(
          Number(
            (_m = item.candlePixPosition) === null || _m === void 0
              ? void 0
              : _m.y
          ),
          Number(
            (_o = item.wickPixPosition) === null || _o === void 0
              ? void 0
              : _o.y
          )
        );
