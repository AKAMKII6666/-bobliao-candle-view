...
export const getshifttime = function (hourShift) {
...
export const ONEMIN = {
    ...
    /* 获得初始化的时间范围 */
    getInitTimeScope: function (initTime) {
        if (initTime === "now") {
 ...
 */
export const findRoundTimeCountFromArray = function (array, timeShift, currentType, key) {
    let getItemTime = function (arr, index) {
    ...
    //查找数量
    let findRoundTimeCount = function (timeType) {
    ...
    for (let timeTypeItem in _timeTypeMap) {
        if (_timeTypeMap.hasOwnProperty(timeTypeItem) &&
            timeTypeItem !== "1w" &&
            timeTypeItem !== "2min" &&
            timeTypeItem !== "3min") {
...
//# sourceMappingURL=timeFormatDefine.js.map