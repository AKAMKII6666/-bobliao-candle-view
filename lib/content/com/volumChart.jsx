...
const VolumChat = ({}, _ref) => {
    ...
    const makeChat = function () {
        ...
        for (var item of CVData.hookObjs.candleObj.data.displayCandleData) {
            ...
            let currentHeight = CVData.hookObjs.candleObj.data.volumChartPixHeight *
                (Number(item.volume) / CVData.hookObjs.candleObj.data.volumChartViewMax);
            if (!item.isEscaped) {
                result.push(<Rectangle key={item.time + "_volume"} color={PIXI.utils.string2hex((function () {
                    ...
                    }} alignX="center" alignY="bottom"></Rectangle>);
            }
            else {
...
//# sourceMappingURL=volumChart.jsx.map